...
**Structure du répertoire des assets :**
...
Le générateur de pages prend en charge l'ajout de favicons à vos pages statiques. Vous pouvez spécifier soit un fichier local depuis votre répertoire d'assets, soit une URL externe.
...
- Détecter automatiquement le fichier dans votre répertoire d'assets
...
<!-- Pour les favicon ICO (inclut la compatibilité avec les anciens navigateurs) -->
...
Le constructeur de pages prend en charge une configuration globale de la navigation qui apparaît sur toutes les pages. La navigation est configurée via un fichier YAML séparé.
