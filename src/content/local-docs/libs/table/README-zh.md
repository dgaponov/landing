...
如果您希望将网格容器用作滚动元素（如果想使用窗口，请参阅窗口虚拟化部分），则使用此功能。请确保在容器上设置固定高度；否则，虚拟化将无法工作。
...
有关表格和列调整大小属性的更多信息，请参阅 react-table [文档](https://tanstack.com/table/v8/docs/api/features/column-sizing)