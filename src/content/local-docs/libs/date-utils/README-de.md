...
Helfer für die Handhabung von Datum und Uhrzeit.
...
// Verwaltung von Locales
settings.getLocale(); // Standard-Locale "en"
...
// Anpassung
settings.updateLocale({weekStart: 0}); // Ersten Tag der Woche ändern
```