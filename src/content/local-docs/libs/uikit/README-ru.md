...
Возможно генерировать начальные CSS-классы корневого элемента на сервере (SSR), чтобы избежать мигания темы:
...
Также есть файл SCSS с [миксинами](styles/mixins.scss), содержащий полезные помощники для использования в вашем приложении.
