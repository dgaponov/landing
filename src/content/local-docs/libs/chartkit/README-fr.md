...
Composant React utilisé pour afficher des graphiques basés sur n'importe quelles sources dont vous avez besoin
...
Assurez-vous d'avoir activé les styles de `@gravity-ui/uikit` dans votre projet.
