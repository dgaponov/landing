...
React-компонент для рендеринга графиков на основе любых источников данных, которые вам нужны
...
Убедитесь, что стили `@gravity-ui/uikit` включены в вашем проекте.
