...
React-Komponente zur Darstellung von Diagrammen basierend auf beliebigen Quellen, die Sie benötigen
...
Stellen Sie sicher, dass die Styles von `@gravity-ui/uikit` in Ihrem Projekt aktiviert sind.
...
const data: YagrWidgetData = {
  ...
  libraryConfig: {
    ...
    title: {
      text: 'Linie: zufällige 10 Punkte',
    },
  },
};
