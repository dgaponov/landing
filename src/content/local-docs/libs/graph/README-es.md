...
No más elegir entre rendimiento e interactividad. Perfecta para diagramas grandes, diagramas de flujo y editores basados en nodos.

## Motivación

Las aplicaciones web modernas a menudo requieren visualizaciones complejas e interactividad, pero las soluciones existentes suelen enfocarse en una sola tecnología de renderizado:
...
- **Zoom alejado**: Usa Canvas para un renderizado eficiente del grafo completo
...
1. Sistema
   ...
   - [Configuraciones del Gráfico](docs/system/graph-settings.md)
