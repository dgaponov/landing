...
- Canvas для высокой производительности при просмотре полного графа
...
- **HTML DOM** удобен для создания интерфейсов, но менее эффективен для сложной графики или большого количества элементов.

@gravity-ui/graph решает эту проблему, автоматически переключаясь между Canvas и HTML в зависимости от уровня масштаба:
- **При отдалении**: использует Canvas для эффективного рендеринга полного графа
...
2. При приближении к детализированному виду компонент `GraphCanvas`:
   ...
   - Вычисляет, какие блоки видимы в текущей области просмотра (с отступами для плавной прокрутки)
...
- [Представление с кастомными блоками](https://preview.gravity-ui.com/graph/?path=/story/stories-main-grapheditor--custom-schematic-block)
