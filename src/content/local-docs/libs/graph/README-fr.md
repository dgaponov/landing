...
> [Guide de migration de 0.x à 1.x →](docs/migration-guides/v0-to-v1.md)
...
Fini le choix entre performance et interactivité. Parfait pour les grands diagrammes, les organigrammes et les éditeurs basés sur des nœuds.

## Motivation

Les applications web modernes nécessitent souvent une visualisation complexe et une interactivité avancée, mais les solutions existantes se concentrent généralement sur une seule technologie de rendu :
...
- **Zoom avant** : Passe aux composants HTML/React pour des interactions riches
...
2. Lors du zoom vers une vue détaillée, le composant `GraphCanvas` :
   ...
   - Calcule quels blocs sont visibles dans le viewport actuel (avec un padding pour un défilement fluide)
...
1. Système
   - [Cycle de vie du composant](docs/system/component-lifecycle.md)
