...
### Боковая навигация с заголовком &middot; [Предпросмотр →](https://preview.yandexcloud.dev/navigation/)
...
4. Унифицировать API для subheaderItem, menuItem, footerItem
...
Используется для тематизации компонентов Navigation