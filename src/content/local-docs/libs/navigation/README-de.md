...
### Seitenleisten-Header-Navigation &middot; [Vorschau →](https://preview.yandexcloud.dev/navigation/)
...
3. Navigation in UIKit Themer unterstützen
4. subheaderItem-, menuItem- und footerItem-API vereinheitlichen
