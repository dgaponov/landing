...
### Navigation avec en-tête latéral &middot; [Aperçu →](https://preview.yandexcloud.dev/navigation/)
...
3. Support de la Navigation dans le themer UIKit
4. Unifier l'API de subheaderItem, menuItem et footerItem
